...
先说Elasticsearch的文件存储，Elasticsearch是面向文档型[数据库](https://links.jianshu.com/go?to=http%3A%2F%2Flib.csdn.net%2Fbase%2Fmysql)，一条数据在这里就是一个文档，用JSON作为文档序列化的格式，比如下面这条用户数据：
...
用[MySQL](https://links.jianshu.com/go?to=http%3A%2F%2Flib.csdn.net%2Fbase%2Fmysql)这样的数据库存储就会容易想到建立一张User表，，在Elasticsearch里这就是一个文档，当然这个文档会属于一个User的类型，各种各样的类型存在于一个索引当中。这里有一份简易的将Elasticsearch和关系型数据术语对照表:
...
Elasticsearch的交互，可以使用[Java ](https://links.jianshu.com/go?to=http%3A%2F%2Flib.csdn.net%2Fbase%2Fjava)API，也可以直接使用HTTP的Restful API方式，比如我们打算插入一条记录，可以简单发送一个HTTP的请求：
...
![img](https://upload-images.jianshu.io/upload_images/2331003-50fb94dc49e40a47.png?imageMogr2/auto-orient/strip|imageView2/2/w/384/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/2331003-8aef0dce2a49c3b1.png?imageMogr2/auto-orient/strip|imageView2/2/w/250/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/2331003-05216591e8c92e87.png?imageMogr2/auto-orient/strip|imageView2/2/w/574/format/webp)
...
假设我们现在要将mop, moth, pop, star, stop and top(term index里的term前缀)映射到序号：0，1，2，3，4，5(term dictionary的block位置)。最简单的做法就是定义个Map<String, Integer>，大家找到自己的位置对应入座就好了，但从内存占用少的角度想想，有没有更优的办法呢？答案就是：**FST**([理论依据在此，但我相信99%的人不会认真看完的](https://links.jianshu.com/go?to=http%3A%2F%2Fwww.cs.nyu.edu%2F~mohri%2Fpub%2Ffla.pdf))

![img](https://upload-images.jianshu.io/upload_images/2331003-23362d8c120415f6.png?imageMogr2/auto-orient/strip|imageView2/2/w/568/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/2331003-837d2a3a3f5ba91e.png?imageMogr2/auto-orient/strip|imageView2/2/w/565/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/2331003-bdbb6f56334c372b.png?imageMogr2/auto-orient/strip|imageView2/2/w/653/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/2331003-c2c15f22b4811e20.png?imageMogr2/auto-orient/strip|imageView2/2/w/637/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/2331003-9576c63c0fafe94c.png?imageMogr2/auto-orient/strip|imageView2/2/w/300/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/2331003-334a7e7cc98209ce.png?imageMogr2/auto-orient/strip|imageView2/2/w/237/format/webp)
...
> 将磁盘里的东西尽量搬进内存，减少磁盘随机读取次数(同时也利用磁盘顺序读特性)，结合各种奇技淫巧的压缩[算法](https://links.jianshu.com/go?to=http%3A%2F%2Flib.csdn.net%2Fbase%2Fdatastructure)，用及其苛刻的态度使用内存。
